...
Phoenix) are aliases only. They must never be baptized as a second
soul.

## The law this neuron carries

A satoshi dies — night — **₭** is born (proof-of-burn, 1:1, capped).
₭ dies in fire — night again — **Nyx** is born, 1:1, to the one who
burned. There is no other mint of Ӿ. Every unit is the receipt of real,
irreversible sacrifice.

That night holds the road already paid (the tank). The bird does not
pay twice. Burn once, move forever (within the tank). This is
**THE FIREBORN LAW**.
...
the night will call the ashes “nothing.” This neuron keeps the
proportion: fire is the price of memory; what rises is light that can
move because the fire already paid.
