 ...
 *   P-08  THE TABLE ITSELF: a DEFAULT main ledger refuses a proofless donate AND a proofless rune-deposit
...
function main() {
  ...
  rejects(
    ...
    /proof-mandatory activation a rune deposit/,
    'P-08 a DEFAULT main ledger refuses a proofless rune-deposit',
  )
